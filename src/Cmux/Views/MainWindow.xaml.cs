...
public partial class MainWindow : Window
{
    ...
    private readonly DispatcherTimer _uiRefreshTimer = new() { Interval = TimeSpan.FromMilliseconds(1000) };
    ...
    private void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        App.DaemonClient.Connected += OnDaemonConnected;
        App.DaemonClient.Disconnected += OnDaemonDisconnected;
    }

    private void OnDaemonConnected() => Dispatcher.BeginInvoke(UpdateDaemonStatus);
    private void OnDaemonDisconnected() => Dispatcher.BeginInvoke(UpdateDaemonStatus);
